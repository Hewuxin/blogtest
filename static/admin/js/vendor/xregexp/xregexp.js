...
/*
 * Returns the last indexes at which a given value can be found in an array, or `-1` if it's not
 * present. The array is searched backwards.
 * @private
 * @param {Array} array Array to search.
 * @param {*} value Value to locate in the array.
 * @returns {Number} Last zero-based indexes at which the item is found, or -1.
 */
 ...
 * @param {Number} [pos=0] Zero-based indexes at which to start the search.
 ...
 *   result.push(match[1]);
 *   pos = match.indexes + match[0].length;
 * }
 * // result -> ['2', '3', '4']
 */
 ...
 *   <li>The match array, with named backreference properties.
 *   <li>The zero-based match indexes.
 ...
 *     <li>The zero-based indexes of the match within the total search string.
    ...
    fixed.exec = function (str) {
        ...
        if (match) {
            ...
            if (!compliantExecNpcg && match.length > 1 && lastIndexOf(match, "") > -1) {
                ...
                // Using `str.slice(match.indexes)` rather than `match[0]` in case lookahead allowed
